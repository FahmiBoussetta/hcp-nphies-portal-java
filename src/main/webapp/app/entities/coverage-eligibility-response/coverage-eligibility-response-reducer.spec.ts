...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './coverage-eligibility-response.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COVERAGEELIGIBILITYRESPONSE_LIST actions', async () => {
    ...
    it('dispatches FETCH_COVERAGEELIGIBILITYRESPONSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COVERAGEELIGIBILITYRESPONSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COVERAGEELIGIBILITYRESPONSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COVERAGEELIGIBILITYRESPONSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COVERAGEELIGIBILITYRESPONSE actions', async () => {
      const expectedActions = [
        {
