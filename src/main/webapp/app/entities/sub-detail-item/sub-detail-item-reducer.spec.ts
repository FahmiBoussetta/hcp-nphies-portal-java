...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBDETAILITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUBDETAILITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUBDETAILITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUBDETAILITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUBDETAILITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUBDETAILITEM actions', async () => {
      const expectedActions = [
        {
