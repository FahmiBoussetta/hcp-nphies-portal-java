...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './information-sequence.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INFORMATIONSEQUENCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_INFORMATIONSEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INFORMATIONSEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INFORMATIONSEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INFORMATIONSEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INFORMATIONSEQUENCE actions', async () => {
      const expectedActions = [
        {
