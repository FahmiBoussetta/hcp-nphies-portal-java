...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './adjudication-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADJUDICATIONITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_ADJUDICATIONITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ADJUDICATIONITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ADJUDICATIONITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ADJUDICATIONITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ADJUDICATIONITEM actions', async () => {
      const expectedActions = [
        {
