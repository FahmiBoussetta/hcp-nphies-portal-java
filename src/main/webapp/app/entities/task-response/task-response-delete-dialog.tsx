...
export const TaskResponseDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(taskResponseEntity.id));
  };
...
export default TaskResponseDeleteDialog;
