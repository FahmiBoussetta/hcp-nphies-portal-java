...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TASKRESPONSE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TASKRESPONSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TASKRESPONSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TASKRESPONSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TASKRESPONSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TASKRESPONSE actions', async () => {
      const expectedActions = [
        {
