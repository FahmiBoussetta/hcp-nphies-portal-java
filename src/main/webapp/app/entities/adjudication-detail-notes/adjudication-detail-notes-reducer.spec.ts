...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADJUDICATIONDETAILNOTES_LIST actions', async () => {
    ...
    it('dispatches FETCH_ADJUDICATIONDETAILNOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ADJUDICATIONDETAILNOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ADJUDICATIONDETAILNOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ADJUDICATIONDETAILNOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ADJUDICATIONDETAILNOTES actions', async () => {
      const expectedActions = [
        {
