...
export const ReferenceIdentifier = (props: RouteComponentProps<{ url: string }>) => {
  const dispatch = useAppDispatch();

  const referenceIdentifierList = useAppSelector(state => state.referenceIdentifier.entities);
...
export default ReferenceIdentifier;
