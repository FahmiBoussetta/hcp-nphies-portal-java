...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './reference-identifier.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REFERENCEIDENTIFIER_LIST actions', async () => {
    ...
    it('dispatches FETCH_REFERENCEIDENTIFIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REFERENCEIDENTIFIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REFERENCEIDENTIFIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REFERENCEIDENTIFIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REFERENCEIDENTIFIER actions', async () => {
      const expectedActions = [
        {
