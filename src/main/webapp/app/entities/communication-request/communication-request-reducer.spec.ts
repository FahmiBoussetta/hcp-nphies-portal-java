...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './communication-request.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMUNICATIONREQUEST_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMMUNICATIONREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMMUNICATIONREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMMUNICATIONREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMMUNICATIONREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMMUNICATIONREQUEST actions', async () => {
      const expectedActions = [
        {
