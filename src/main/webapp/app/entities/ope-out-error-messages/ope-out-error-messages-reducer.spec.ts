...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './ope-out-error-messages.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPEOUTERRORMESSAGES_LIST actions', async () => {
    ...
    it('dispatches FETCH_OPEOUTERRORMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OPEOUTERRORMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OPEOUTERRORMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OPEOUTERRORMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OPEOUTERRORMESSAGES actions', async () => {
      const expectedActions = [
        {
