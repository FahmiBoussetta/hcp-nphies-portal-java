...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HOSPITALIZATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_HOSPITALIZATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HOSPITALIZATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HOSPITALIZATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HOSPITALIZATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HOSPITALIZATION actions', async () => {
      const expectedActions = [
        {
