...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './claim.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLAIM_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLAIM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLAIM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLAIM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLAIM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLAIM actions', async () => {
      const expectedActions = [
        {
