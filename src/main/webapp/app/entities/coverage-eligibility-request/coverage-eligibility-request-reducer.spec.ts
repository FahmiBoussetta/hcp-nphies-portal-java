...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './coverage-eligibility-request.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COVERAGEELIGIBILITYREQUEST_LIST actions', async () => {
    ...
    it('dispatches FETCH_COVERAGEELIGIBILITYREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COVERAGEELIGIBILITYREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COVERAGEELIGIBILITYREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COVERAGEELIGIBILITYREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COVERAGEELIGIBILITYREQUEST actions', async () => {
      const expectedActions = [
        {
