...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSCOMPONENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLASSCOMPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLASSCOMPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLASSCOMPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLASSCOMPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLASSCOMPONENT actions', async () => {
      const expectedActions = [
        {
