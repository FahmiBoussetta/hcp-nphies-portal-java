...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './insurance-benefit.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSURANCEBENEFIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_INSURANCEBENEFIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INSURANCEBENEFIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INSURANCEBENEFIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INSURANCEBENEFIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INSURANCEBENEFIT actions', async () => {
      const expectedActions = [
        {
