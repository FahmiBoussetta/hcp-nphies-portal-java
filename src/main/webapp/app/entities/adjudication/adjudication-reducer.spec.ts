...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADJUDICATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_ADJUDICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ADJUDICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ADJUDICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ADJUDICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ADJUDICATION actions', async () => {
      const expectedActions = [
        {
