...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './adjudication-notes.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADJUDICATIONNOTES_LIST actions', async () => {
    ...
    it('dispatches FETCH_ADJUDICATIONNOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ADJUDICATIONNOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ADJUDICATIONNOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ADJUDICATIONNOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ADJUDICATIONNOTES actions', async () => {
      const expectedActions = [
        {
