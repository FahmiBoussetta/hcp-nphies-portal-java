...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './accident.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCIDENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACCIDENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCIDENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCIDENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCIDENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCIDENT actions', async () => {
      const expectedActions = [
        {
