...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './list-communication-medium-enum.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LISTCOMMUNICATIONMEDIUMENUM_LIST actions', async () => {
    ...
    it('dispatches FETCH_LISTCOMMUNICATIONMEDIUMENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LISTCOMMUNICATIONMEDIUMENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LISTCOMMUNICATIONMEDIUMENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LISTCOMMUNICATIONMEDIUMENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LISTCOMMUNICATIONMEDIUMENUM actions', async () => {
      const expectedActions = [
        {
