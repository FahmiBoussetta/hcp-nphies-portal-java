...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTRECONCILIATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAYMENTRECONCILIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYMENTRECONCILIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYMENTRECONCILIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTRECONCILIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYMENTRECONCILIATION actions', async () => {
      const expectedActions = [
        {
