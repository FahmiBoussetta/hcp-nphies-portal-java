...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './payload.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYLOAD_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAYLOAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYLOAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYLOAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYLOAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYLOAD actions', async () => {
      const expectedActions = [
        {
