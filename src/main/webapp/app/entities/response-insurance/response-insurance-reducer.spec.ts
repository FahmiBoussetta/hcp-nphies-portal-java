...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './response-insurance.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESPONSEINSURANCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_RESPONSEINSURANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESPONSEINSURANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESPONSEINSURANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESPONSEINSURANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESPONSEINSURANCE actions', async () => {
      const expectedActions = [
        {
