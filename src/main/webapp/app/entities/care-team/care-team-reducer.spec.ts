...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './care-team.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARETEAM_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARETEAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARETEAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARETEAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARETEAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARETEAM actions', async () => {
      const expectedActions = [
        {
