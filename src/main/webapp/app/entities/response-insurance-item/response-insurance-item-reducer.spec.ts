...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './response-insurance-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESPONSEINSURANCEITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_RESPONSEINSURANCEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESPONSEINSURANCEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESPONSEINSURANCEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESPONSEINSURANCEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESPONSEINSURANCEITEM actions', async () => {
      const expectedActions = [
        {
