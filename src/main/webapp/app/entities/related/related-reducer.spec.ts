...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './related.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RELATED_LIST actions', async () => {
    ...
    it('dispatches FETCH_RELATED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RELATED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RELATED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RELATED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RELATED actions', async () => {
      const expectedActions = [
        {
