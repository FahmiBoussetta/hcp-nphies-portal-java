...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './diagnosis-sequence.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIAGNOSISSEQUENCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DIAGNOSISSEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DIAGNOSISSEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DIAGNOSISSEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DIAGNOSISSEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DIAGNOSISSEQUENCE actions', async () => {
      const expectedActions = [
        {
