...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './cr-error-messages.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRERRORMESSAGES_LIST actions', async () => {
    ...
    it('dispatches FETCH_CRERRORMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRERRORMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRERRORMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRERRORMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRERRORMESSAGES actions', async () => {
      const expectedActions = [
        {
