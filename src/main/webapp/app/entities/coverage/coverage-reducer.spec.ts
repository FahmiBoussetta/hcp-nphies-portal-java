...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './coverage.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COVERAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_COVERAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COVERAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COVERAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COVERAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COVERAGE actions', async () => {
      const expectedActions = [
        {
