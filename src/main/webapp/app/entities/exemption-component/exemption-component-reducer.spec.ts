...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXEMPTIONCOMPONENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_EXEMPTIONCOMPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXEMPTIONCOMPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXEMPTIONCOMPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXEMPTIONCOMPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXEMPTIONCOMPONENT actions', async () => {
      const expectedActions = [
        {
