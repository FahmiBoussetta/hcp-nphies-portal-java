...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DETAILITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_DETAILITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DETAILITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DETAILITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DETAILITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DETAILITEM actions', async () => {
      const expectedActions = [
        {
