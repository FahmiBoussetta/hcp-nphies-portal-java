...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLAIMRESPONSE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLAIMRESPONSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLAIMRESPONSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLAIMRESPONSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLAIMRESPONSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLAIMRESPONSE actions', async () => {
      const expectedActions = [
        {
