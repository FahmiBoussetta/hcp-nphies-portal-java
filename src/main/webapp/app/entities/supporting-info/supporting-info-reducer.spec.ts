...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUPPORTINGINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUPPORTINGINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUPPORTINGINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUPPORTINGINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUPPORTINGINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUPPORTINGINFO actions', async () => {
      const expectedActions = [
        {
