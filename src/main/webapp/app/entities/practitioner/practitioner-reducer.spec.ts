...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRACTITIONER_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRACTITIONER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRACTITIONER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRACTITIONER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRACTITIONER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRACTITIONER actions', async () => {
      const expectedActions = [
        {
