...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './list-role-code-enum.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LISTROLECODEENUM_LIST actions', async () => {
    ...
    it('dispatches FETCH_LISTROLECODEENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LISTROLECODEENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LISTROLECODEENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LISTROLECODEENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LISTROLECODEENUM actions', async () => {
      const expectedActions = [
        {
