...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACKNOWLEDGEMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACKNOWLEDGEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACKNOWLEDGEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACKNOWLEDGEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACKNOWLEDGEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACKNOWLEDGEMENT actions', async () => {
      const expectedActions = [
        {
