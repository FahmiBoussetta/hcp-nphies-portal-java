...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TASKINPUT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TASKINPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TASKINPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TASKINPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TASKINPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TASKINPUT actions', async () => {
      const expectedActions = [
        {
