...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HUMANNAME_LIST actions', async () => {
    ...
    it('dispatches FETCH_HUMANNAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HUMANNAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HUMANNAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HUMANNAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HUMANNAME actions', async () => {
      const expectedActions = [
        {
