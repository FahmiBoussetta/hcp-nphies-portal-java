...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './operation-outcome.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPERATIONOUTCOME_LIST actions', async () => {
    ...
    it('dispatches FETCH_OPERATIONOUTCOME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OPERATIONOUTCOME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OPERATIONOUTCOME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OPERATIONOUTCOME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OPERATIONOUTCOME actions', async () => {
      const expectedActions = [
        {
