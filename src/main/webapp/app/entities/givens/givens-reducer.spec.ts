...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './givens.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GIVENS_LIST actions', async () => {
    ...
    it('dispatches FETCH_GIVENS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GIVENS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GIVENS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GIVENS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GIVENS actions', async () => {
      const expectedActions = [
        {
