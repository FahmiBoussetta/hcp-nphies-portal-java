...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TASKOUTPUT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TASKOUTPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TASKOUTPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TASKOUTPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TASKOUTPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TASKOUTPUT actions', async () => {
      const expectedActions = [
        {
