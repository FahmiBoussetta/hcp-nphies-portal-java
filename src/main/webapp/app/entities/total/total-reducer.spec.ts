...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './total.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOTAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOTAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOTAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOTAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOTAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOTAL actions', async () => {
      const expectedActions = [
        {
