...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './cov-eli-error-messages.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COVELIERRORMESSAGES_LIST actions', async () => {
    ...
    it('dispatches FETCH_COVELIERRORMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COVELIERRORMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COVELIERRORMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COVELIERRORMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COVELIERRORMESSAGES actions', async () => {
      const expectedActions = [
        {
