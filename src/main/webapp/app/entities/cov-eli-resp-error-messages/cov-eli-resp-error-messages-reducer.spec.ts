...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './cov-eli-resp-error-messages.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COVELIRESPERRORMESSAGES_LIST actions', async () => {
    ...
    it('dispatches FETCH_COVELIRESPERRORMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COVELIRESPERRORMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COVELIRESPERRORMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COVELIRESPERRORMESSAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COVELIRESPERRORMESSAGES actions', async () => {
      const expectedActions = [
        {
