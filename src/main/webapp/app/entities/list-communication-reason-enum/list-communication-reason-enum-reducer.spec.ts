...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './list-communication-reason-enum.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LISTCOMMUNICATIONREASONENUM_LIST actions', async () => {
    ...
    it('dispatches FETCH_LISTCOMMUNICATIONREASONENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LISTCOMMUNICATIONREASONENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LISTCOMMUNICATIONREASONENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LISTCOMMUNICATIONREASONENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LISTCOMMUNICATIONREASONENUM actions', async () => {
      const expectedActions = [
        {
