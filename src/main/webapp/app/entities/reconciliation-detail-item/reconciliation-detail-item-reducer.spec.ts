...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './reconciliation-detail-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECONCILIATIONDETAILITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_RECONCILIATIONDETAILITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RECONCILIATIONDETAILITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RECONCILIATIONDETAILITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RECONCILIATIONDETAILITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RECONCILIATIONDETAILITEM actions', async () => {
      const expectedActions = [
        {
