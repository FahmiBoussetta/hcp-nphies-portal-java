...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './practitioner-role.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRACTITIONERROLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRACTITIONERROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRACTITIONERROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRACTITIONERROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRACTITIONERROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRACTITIONERROLE actions', async () => {
      const expectedActions = [
        {
