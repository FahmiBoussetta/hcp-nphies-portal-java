...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTNOTICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAYMENTNOTICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYMENTNOTICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYMENTNOTICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTNOTICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYMENTNOTICE actions', async () => {
      const expectedActions = [
        {
