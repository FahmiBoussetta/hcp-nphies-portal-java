...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './adjudication-detail-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADJUDICATIONDETAILITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_ADJUDICATIONDETAILITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ADJUDICATIONDETAILITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ADJUDICATIONDETAILITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ADJUDICATIONDETAILITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ADJUDICATIONDETAILITEM actions', async () => {
      const expectedActions = [
        {
