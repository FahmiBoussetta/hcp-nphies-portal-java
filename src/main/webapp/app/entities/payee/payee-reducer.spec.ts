...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './payee.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYEE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAYEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYEE actions', async () => {
      const expectedActions = [
        {
