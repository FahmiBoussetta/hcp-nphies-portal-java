...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './cost-to-beneficiary-component.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COSTTOBENEFICIARYCOMPONENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_COSTTOBENEFICIARYCOMPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COSTTOBENEFICIARYCOMPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COSTTOBENEFICIARYCOMPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COSTTOBENEFICIARYCOMPONENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COSTTOBENEFICIARYCOMPONENT actions', async () => {
      const expectedActions = [
        {
