...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './quantity.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUANTITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_QUANTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_QUANTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_QUANTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_QUANTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_QUANTITY actions', async () => {
      const expectedActions = [
        {
