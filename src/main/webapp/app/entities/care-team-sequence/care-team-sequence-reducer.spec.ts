...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './care-team-sequence.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARETEAMSEQUENCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARETEAMSEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARETEAMSEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARETEAMSEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARETEAMSEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARETEAMSEQUENCE actions', async () => {
      const expectedActions = [
        {
