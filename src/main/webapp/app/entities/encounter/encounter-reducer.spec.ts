...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './encounter.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENCOUNTER_LIST actions', async () => {
    ...
    it('dispatches FETCH_ENCOUNTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ENCOUNTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ENCOUNTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ENCOUNTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ENCOUNTER actions', async () => {
      const expectedActions = [
        {
