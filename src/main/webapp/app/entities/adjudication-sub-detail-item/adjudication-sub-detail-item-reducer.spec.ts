...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './adjudication-sub-detail-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADJUDICATIONSUBDETAILITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_ADJUDICATIONSUBDETAILITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ADJUDICATIONSUBDETAILITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ADJUDICATIONSUBDETAILITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ADJUDICATIONSUBDETAILITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ADJUDICATIONSUBDETAILITEM actions', async () => {
      const expectedActions = [
        {
