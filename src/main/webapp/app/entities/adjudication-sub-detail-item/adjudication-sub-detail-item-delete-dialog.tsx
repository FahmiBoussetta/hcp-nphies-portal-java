...
export const AdjudicationSubDetailItemDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(adjudicationSubDetailItemEntity.id));
  };
...
export default AdjudicationSubDetailItemDeleteDialog;
