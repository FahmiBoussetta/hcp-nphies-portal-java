...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './list-specialty-enum.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LISTSPECIALTYENUM_LIST actions', async () => {
    ...
    it('dispatches FETCH_LISTSPECIALTYENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LISTSPECIALTYENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LISTSPECIALTYENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LISTSPECIALTYENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LISTSPECIALTYENUM actions', async () => {
      const expectedActions = [
        {
