...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LISTELIGIBILITYPURPOSEENUM_LIST actions', async () => {
    ...
    it('dispatches FETCH_LISTELIGIBILITYPURPOSEENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LISTELIGIBILITYPURPOSEENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LISTELIGIBILITYPURPOSEENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LISTELIGIBILITYPURPOSEENUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LISTELIGIBILITYPURPOSEENUM actions', async () => {
      const expectedActions = [
        {
