...
/**
 * REST controller for managing {@link com.platformsandsolutions.hcpnphiesportal.domain.Organization}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Organization> result = organizationRepository
            ...
            .map(
                existingOrganization -> {
                    if (organization.getGuid() != null) {
                        existingOrganization.setGuid(organization.getGuid());
                    }
                    if (organization.getForceId() != null) {
                        existingOrganization.setForceId(organization.getForceId());
                    }
                    if (organization.getOrganizationLicense() != null) {
                        existingOrganization.setOrganizationLicense(organization.getOrganizationLicense());
                    }
                    if (organization.getBaseUrl() != null) {
                        existingOrganization.setBaseUrl(organization.getBaseUrl());
                    }
