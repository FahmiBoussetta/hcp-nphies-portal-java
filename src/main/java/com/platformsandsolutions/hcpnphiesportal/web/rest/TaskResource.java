            ...
            .map(
                existingTask -> {
                    if (task.getGuid() != null) {
                        existingTask.setGuid(task.getGuid());
                    }
                    if (task.getIsQueued() != null) {
                        existingTask.setIsQueued(task.getIsQueued());
                    }
                    if (task.getParsed() != null) {
                        existingTask.setParsed(task.getParsed());
                    }
                    if (task.getIdentifier() != null) {
                        existingTask.setIdentifier(task.getIdentifier());
                    }
                    if (task.getCode() != null) {
                        existingTask.setCode(task.getCode());
                    }
                    if (task.getDescription() != null) {
                        existingTask.setDescription(task.getDescription());
                    }
                    if (task.getFocus() != null) {
                        existingTask.setFocus(task.getFocus());
                    }
                    if (task.getReasonCode() != null) {
                        existingTask.setReasonCode(task.getReasonCode());
                    }
