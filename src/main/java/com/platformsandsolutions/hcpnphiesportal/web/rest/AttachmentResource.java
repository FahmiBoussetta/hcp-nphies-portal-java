...
/**
 * REST controller for managing {@link com.platformsandsolutions.hcpnphiesportal.domain.Attachment}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Attachment> result = attachmentRepository
            ...
            .map(
                existingAttachment -> {
                    ...
                    if (attachment.getLanguage() != null) {
                        existingAttachment.setLanguage(attachment.getLanguage());
                    }
                    if (attachment.getIsData() != null) {
                        existingAttachment.setIsData(attachment.getIsData());
                    }
                    if (attachment.getDataFile() != null) {
                        existingAttachment.setDataFile(attachment.getDataFile());
                    }
                    if (attachment.getDataFileContentType() != null) {
                        existingAttachment.setDataFileContentType(attachment.getDataFileContentType());
                    }
                    if (attachment.getUrl() != null) {
                        existingAttachment.setUrl(attachment.getUrl());
                    }
                    if (attachment.getAttachmentSize() != null) {
                        existingAttachment.setAttachmentSize(attachment.getAttachmentSize());
                    }
                    if (attachment.getHash() != null) {
                        existingAttachment.setHash(attachment.getHash());
                    }
                    if (attachment.getHashContentType() != null) {
                        existingAttachment.setHashContentType(attachment.getHashContentType());
                    }
