 ...
 * {@link com.platformsandsolutions.hcpnphiesportal.domain.ReferenceIdentifier}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ReferenceIdentifierResource {
     ...
     *         body the new referenceIdentifier, or with status
     *         {@code 400 (Bad Request)} if the referenceIdentifier has already an
     *         ID.
    ...
    /**
     * {@code PUT  /reference-identifiers/:id} : Updates an existing
     * referenceIdentifier.
     *
     ...
     *         the updated referenceIdentifier,
     *         or with status {@code 400 (Bad Request)} if the referenceIdentifier
     *         is not valid,
     *         or with status {@code 500 (Internal Server Error)} if the
     *         referenceIdentifier couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    /**
     * {@code PATCH  /reference-identifiers/:id} : Partial updates given fields of
     * an existing referenceIdentifier, field will ignore if it is null
     *
     * @param id                  the id of the referenceIdentifier to save.
     * @param referenceIdentifier the referenceIdentifier to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     ...
     *         or with status {@code 400 (Bad Request)} if the referenceIdentifier
     *         is not valid,
     *         or with status {@code 404 (Not Found)} if the referenceIdentifier is
     *         not found,
     *         or with status {@code 500 (Internal Server Error)} if the
     *         referenceIdentifier couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
        ...
        Optional<ReferenceIdentifier> result = referenceIdentifierRepository
            ...
            .map(
                existingReferenceIdentifier -> {
                    if (referenceIdentifier.getType() != null) {
                        existingReferenceIdentifier.setType(referenceIdentifier.getType());
                    }
                    if (referenceIdentifier.getReference() != null) {
                        existingReferenceIdentifier.setReference(referenceIdentifier.getReference());
                    }
                    if (referenceIdentifier.getSystem() != null) {
                        existingReferenceIdentifier.setSystem(referenceIdentifier.getSystem());
                    }
                    if (referenceIdentifier.getValue() != null) {
                        existingReferenceIdentifier.setValue(referenceIdentifier.getValue());
                    }
     ...
     *         of referenceIdentifiers in body.
     */
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the referenceIdentifier, or with status {@code 404 (Not Found)}.
     */
    ...
    /**
     * {@code DELETE  /reference-identifiers/:id} : delete the "id"
     * referenceIdentifier.
     *
